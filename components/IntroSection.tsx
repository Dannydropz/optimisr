...
const IntroSection: React.FC = () => {
    return (
        <motion.section
            ...
            className="section-stack bg-optimisr-black text-white pt-24 md:pt-32 pb-24 md:pb-40 px-6 md:px-12 xl:px-20 -mt-[100px] overflow-clip"
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {items.map((item, i) => (
                        <motion.div 
                            ...
                            className="flex flex-col bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-colors duration-300"
                        >
